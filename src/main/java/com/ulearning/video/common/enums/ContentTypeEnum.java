...
public enum ContentTypeEnum {
    ...
    private static Map<String, ContentTypeEnum> suffixMap;

    static {
        suffixMap = Arrays.stream(ContentTypeEnum.values())
                .collect(
                        Collectors.toMap(
                                ContentTypeEnum::getSuffix,
                                Function.identity()
                        )
                );
    }
    ...
    public static String getContentTypeByFile(File file) {
        ...
        ContentTypeEnum contentTypeEnum = suffixMap.get(fileName.substring(fileName.lastIndexOf(".")));
